    ...
    const CustomOnchainTxsTooltip = props => {
        ...
        if (active && payload && payload.length) {
            ...
            return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: {
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { style: { margin: 0, marginBottom: '3px', color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].accent_medium, textTransform: 'capitalize' } }, `Top 50 / Recent 10k ${native} txs`)));
        }
        return null;
    };
...
/* harmony import */ var _mui_material_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @mui/material/ToggleButtonGroup */ "./node_modules/@mui/material/ToggleButtonGroup/ToggleButtonGroup.js");
/* harmony import */ var _mui_icons_material_CurrencyBitcoin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @mui/icons-material/CurrencyBitcoin */ "./node_modules/@mui/icons-material/CurrencyBitcoin.js");
/* harmony import */ var _mui_icons_material_Wallpaper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @mui/icons-material/Wallpaper */ "./node_modules/@mui/icons-material/Wallpaper.js");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
const OverlayMenu = ({ menuIsOpen, setMenuIsOpen }) => {
    ...
    const handleSupportClick = () => __awaiter(void 0, void 0, void 0, function* () {
        chrome.tabs.create({ url: "https://twitter.com/Marty_cFly", active: false });
    });
    const [searchPref, setSearchPref] = react__WEBPACK_IMPORTED_MODULE_0___default().useState('tokens');
    const [tokenNftRatio, setTokenNftRatio] = react__WEBPACK_IMPORTED_MODULE_0___default().useState(1);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: menuIsOpen ? Object.assign(Object.assign({}, styles.overlayMenu), styles.overlayMenuOpen) : styles.overlayMenu },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: menuIsOpen ? Object.assign(Object.assign({}, styles.menuContent), styles.menuContentOpen) : styles.menuContent },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.menuCloseButton },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Close__WEBPACK_IMPORTED_MODULE_3__["default"], { style: { fontSize: 24, cursor: 'pointer', color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_medium }, onClick: () => setMenuIsOpen(false) })),
                menuIsOpen &&
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.sectionHeader }, "Search result priority"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_4__["default"], { size: "small", color: "primary", value: searchPref, exclusive: true, onChange: (event, newSearchPref) => { setSearchPref(newSearchPref); }, "aria-label": "SearchPref" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_5__["default"], { value: "tokens" },
                                " ",
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_CurrencyBitcoin__WEBPACK_IMPORTED_MODULE_6__["default"], { style: { fontSize: 24, color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_medium } }),
                                " "),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_5__["default"], { value: "nfts" },
                                " ",
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Wallpaper__WEBPACK_IMPORTED_MODULE_7__["default"], { style: { fontSize: 24, color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_medium } }),
                                " ")),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.sectionHeader }, "Search result Coin vs NFTs"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Box__WEBPACK_IMPORTED_MODULE_8__["default"], { sx: { width: 200 } },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Stack__WEBPACK_IMPORTED_MODULE_9__["default"], { spacing: 2, direction: "row", sx: { mb: 1 }, alignItems: "center" },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_CurrencyBitcoin__WEBPACK_IMPORTED_MODULE_6__["default"], { style: { fontSize: 24, color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_medium } }),
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Slider__WEBPACK_IMPORTED_MODULE_10__["default"], { size: "small", "aria-label": "Coin vs NFT ratio", value: tokenNftRatio, valueLabelDisplay: "auto", onChange: (event, newTokenNftRatio) => {
                                    ...
                                    }, step: 1, marks: true, min: 3, max: 10, style: { color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_medium } }),
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { width: "100%" } }, "/ 12 results"))),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_QuestionAnswer__WEBPACK_IMPORTED_MODULE_11__["default"], { style: { fontSize: 24, cursor: 'pointer', color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_medium, marginTop: '20px' }, onClick: () => handleSupportClick }))))));
};
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_react-dom_index_js","vendors-node_modules_mui_icons-material_Close_js-node_modules_mui_icons-material_CurrencyBitc-3e07b6"], () => (__webpack_require__("./src/popup/popup.tsx")))
