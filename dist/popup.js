...
const HeaderBlock = ({ mainLogo, setCoinInfo, setNftInfo, setTxVolumeChartData, setTokenTxsChartData, setMenuIsOpen, }) => {
    ...
    const checkStorage = () => __awaiter(void 0, void 0, void 0, function* () {
        const startPref = yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.getStartPrefStorage)();
        if (startPref === "search") {
            setMenuIsOpen(false);
        }
        else {
        ...
        // } else {
        const homeCoinStorage = yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.getHomeCoinStorage)();
    ...
    const searchCoinNames = (searchInputProp) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const nrOfNfts = (yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.getSearchResultNftAmountStorage)()) || 3;
            let displayNrOfNfts = Math.min(searchResults.nfts.length, nrOfNfts);
            let displayNrOfCoins = 11 - displayNrOfNfts;
            const searchpreference = (yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.getSearchPrefStorage)()) || "coins";
    ...
    const fetchDetailedNftInfo = (coinId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            setTxVolumeChartData([]);
            setTokenTxsChartData([]);
            const [nftInfo] = yield Promise.all([(0,_utils_api__WEBPACK_IMPORTED_MODULE_3__.fetchNftInfo)(coinId)]);
            if (!nftInfo) {
                setLoadingError({ isLoading: false, isError: true });
    ...
    const handleCoinOptionClick = (tokenInfo) => __awaiter(void 0, void 0, void 0, function* () {
        if (!tokenInfo.nft) {
            ...
            yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.setHomeCoinStorage)({ id: tokenInfo.id, nft: false });
        }
        else {
            fetchDetailedNftInfo(tokenInfo.id);
            yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.setHomeCoinStorage)({ id: tokenInfo.id, nft: true });
        }
        setIsExpanded(false);
    });
    function getNftTxChartData(platformId, contractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let nftTxsData = yield (0,_utils_api__WEBPACK_IMPORTED_MODULE_3__.fetchNftTxs)(domain, contractAddress, 10000);
            if (nftTxsData.status === "0") {
                console.log("nftTxsData.status ==== 0: ", nftTxsData);
                yield delay(5500);
                nftTxsData = yield (0,_utils_api__WEBPACK_IMPORTED_MODULE_3__.fetchNftTxs)(domain, contractAddress, 10000);
            }
    ...
    function getTokenTxChartData(platformId, contractAddress, tokenValue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let tokenTxsData = yield (0,_utils_api__WEBPACK_IMPORTED_MODULE_3__.fetchTokenTxs)(domain, contractAddress, 10000);
            if (tokenTxsData.status === "0") {
                console.log("tokenTxsData.status ==== 0: ", tokenTxsData);
                yield delay(5500);
                tokenTxsData = yield (0,_utils_api__WEBPACK_IMPORTED_MODULE_3__.fetchTokenTxs)(domain, contractAddress, 10000);
            }
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.headerBlock },
            ...
            !loadingError.isError && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { style: styles.mainLogo, src: mainLogo ||
                    "https://assets.coingecko.com/coins/images/5/small/dogecoin.png?1547792256", alt: "Main Logo" })),
            loadingError.isLoading && !loadingError.isError && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_CircularProgress__WEBPACK_IMPORTED_MODULE_7__["default"], { size: 41, thickness: 1, style: {
                    position: "absolute",
                    right: 12,
                    zIndex: 1,
                    color: "white",
                } })),
            loadingError.isError && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.indicationIcon, title: "Refresh limit: 5/sec" },
...
/* harmony import */ var _static_colors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../static/colors */ "./src/static/colors.tsx");
/* harmony import */ var _static_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../static/constants */ "./src/static/constants.tsx");
/* harmony import */ var _mui_icons_material_QuestionAnswer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @mui/icons-material/QuestionAnswer */ "./node_modules/@mui/icons-material/QuestionAnswer.js");
...
/* harmony import */ var _mui_material_Slider__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @mui/material/Slider */ "./node_modules/@mui/material/Slider/Slider.js");
/* harmony import */ var _mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @mui/material/ToggleButton */ "./node_modules/@mui/material/ToggleButton/ToggleButton.js");
/* harmony import */ var _mui_material_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @mui/material/ToggleButtonGroup */ "./node_modules/@mui/material/ToggleButtonGroup/ToggleButtonGroup.js");
/* harmony import */ var _mui_icons_material_CurrencyBitcoin__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @mui/icons-material/CurrencyBitcoin */ "./node_modules/@mui/icons-material/CurrencyBitcoin.js");
/* harmony import */ var _mui_icons_material_Wallpaper__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @mui/icons-material/Wallpaper */ "./node_modules/@mui/icons-material/Wallpaper.js");
...
/* harmony import */ var _mui_icons_material_QueryStats__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @mui/icons-material/QueryStats */ "./node_modules/@mui/icons-material/QueryStats.js");
...
/* harmony import */ var _overlayComponents_WalletTrackerBlock__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./overlayComponents/WalletTrackerBlock */ "./src/components/overlayComponents/WalletTrackerBlock.tsx");
/* harmony import */ var _overlayComponents_PortfolioBlock__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./overlayComponents/PortfolioBlock */ "./src/components/overlayComponents/PortfolioBlock.tsx");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
const OverlayMenu = ({ menuIsOpen, setMenuIsOpen, coinInfo, nftInfo, }) => {
    ...
    const handleSearchPref = (newSearchPref) => {
        if (newSearchPref !== null) {
            ...
            (0,_utils_storage__WEBPACK_IMPORTED_MODULE_3__.setSearchPrefStorage)(newSearchPref);
        }
    };
    const handleStartPref = (newStartPref) => {
        if (newStartPref !== null) {
            setStartPref(newStartPref);
            (0,_utils_storage__WEBPACK_IMPORTED_MODULE_3__.setStartPrefStorage)(newStartPref);
        }
    };
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: menuIsOpen
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: menuIsOpen
            ...
            menuIsOpen && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.scrollContainer },
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.sectionHeader }, "Start Priority"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.explanationSubtext }, "Portfolio/ Search first"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_10__["default"], { size: "small", color: "primary", value: startPref, exclusive: true, "aria-label": "StartPref" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_8__["default"], { value: "portfolio", style: Object.assign(Object.assign({}, styles.togglePrefButton), (startPref === "portfolio" && styles.activePrefButton)), onClick: () => handleStartPref("portfolio") },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_QueryStats__WEBPACK_IMPORTED_MODULE_11__["default"], { style: styles.togglePrefButtonIcon })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_8__["default"], { value: "search", style: Object.assign(Object.assign({}, styles.togglePrefButton), (startPref === "search" && styles.activePrefButton)), onClick: () => handleStartPref("search") },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Search__WEBPACK_IMPORTED_MODULE_12__["default"], { style: styles.togglePrefButtonIcon }))),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.sectionHeader }, "Search Priority"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.explanationSubtext }, "Show Coins/ Nfts first"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_10__["default"], { size: "small", color: "primary", value: searchPref, exclusive: true, "aria-label": "SearchPref" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_8__["default"], { value: "coins", style: Object.assign(Object.assign({}, styles.togglePrefButton), (searchPref === "coins" && styles.activePrefButton)), onClick: () => handleSearchPref("coins") },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_CurrencyBitcoin__WEBPACK_IMPORTED_MODULE_13__["default"], { style: styles.togglePrefButtonIcon })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_8__["default"], { value: "nfts", style: Object.assign(Object.assign({}, styles.togglePrefButton), (searchPref === "nfts" && styles.activePrefButton)), onClick: () => handleSearchPref("nfts") },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Wallpaper__WEBPACK_IMPORTED_MODULE_14__["default"], { style: styles.togglePrefButtonIcon }))),
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Box__WEBPACK_IMPORTED_MODULE_15__["default"], { sx: { width: 180 } },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Slider__WEBPACK_IMPORTED_MODULE_16__["default"], { size: "small", "aria-label": "Max Nfts out of 11 search results", value: searchResultNftAmount, valueLabelDisplay: "auto", onChange: (event, newTokenNftRatio) => {
...
/***/ "./src/components/overlayComponents/PortfolioBlock.tsx":
/*!*************************************************************!*\
  !*** ./src/components/overlayComponents/PortfolioBlock.tsx ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const PortfolioBlock = ({ portfolioData, setPortfolioData, loading, }) => {
    const styles = {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        showInputField && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.inputContainer },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.inputContainerSaveButton, onClick: handleSaveAmountInput },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Save__WEBPACK_IMPORTED_MODULE_5__["default"], { style: { fontSize: 14, color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].white_medium } })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.inputContainerDeleteButton, onClick: handleRemoveCoinButton },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Delete__WEBPACK_IMPORTED_MODULE_6__["default"], { style: { fontSize: 14, color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].white_medium } }),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioItemField },
            (portfolioData === null || portfolioData === void 0 ? void 0 : portfolioData.length) > 0 && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioHeader },
            ...
            (portfolioData === null || portfolioData === void 0 ? void 0 : portfolioData.length) > 0 ? (portfolioData.map((coinInfo) => {
                var _a;
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { key: coinInfo.id },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioItemDataField },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioItemTopRow },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.portfolioItemValue },
                                    "$",
                                    (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(coinInfo.price)),
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.amountText }, coinInfo.amount > 0
                                    ? (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(coinInfo.amount)
                                    : "-"),
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.portfolioItemValue }, coinInfo.amount > 0
                                    ? `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(coinInfo.price * coinInfo.amount)}`
                                    : "-")),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioItemBottomRow },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: Object.assign(Object.assign({}, styles.portfolioItemValue), { color: coinInfo.usd24Change > 0
                                            ...
                                            : _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].red_medium }) }, `${coinInfo.usd24Change
                                    ? (_a = coinInfo.usd24Change) === null || _a === void 0 ? void 0 : _a.toFixed(1)
                                    : "-"}%`)))),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioItemDivider })));
            })) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.noCoinsText }, "No coins in portfolio, add coins at the bottom of a page")))));
};
...
/***/ "./src/components/overlayComponents/WalletTrackerBlock.tsx":
/*!*****************************************************************!*\
  !*** ./src/components/overlayComponents/WalletTrackerBlock.tsx ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_OverlayMenu__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../components/OverlayMenu */ "./src/components/OverlayMenu.tsx");
...
const App = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.topContainer },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_HeaderBlock__WEBPACK_IMPORTED_MODULE_9__["default"], { mainLogo: ((_a = coinInfo === null || coinInfo === void 0 ? void 0 : coinInfo.image) === null || _a === void 0 ? void 0 : _a.small)
                    ? coinInfo.image.small
                    : ((_b = nftInfo === null || nftInfo === void 0 ? void 0 : nftInfo.image) === null || _b === void 0 ? void 0 : _b.small)
                        ? nftInfo.image.small
                        : bitcoinIcon, setCoinInfo: setCoinInfo, setNftInfo: setNftInfo, setTxVolumeChartData: setTxVolumeChartData, setTokenTxsChartData: setTokenTxsChartData, setMenuIsOpen: setMenuIsOpen })),
...
const CACHE_TIME_SHORT = 600000; // 5 minutes
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_react-dom_index_js","vendors-node_modules_mui_icons-material_Close_js-node_modules_mui_icons-material_CurrencyBitc-b0dca7"], () => (__webpack_require__("./src/popup/popup.tsx")))
