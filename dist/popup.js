...
const fetchDetailedTokenInfo = (coinId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        coinInfo = Object.assign({}, fetchedCoinInfo);
...
const getNftTxChartData = (platformId, contractAddress) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(`getTokenTxChartData error: Couldn't find txs for: ${contractAddress} on ${platformId}`);
    return null;
});
...
/***/ "./src/components/ChartsField.tsx":
/*!****************************************!*\
  !*** ./src/components/ChartsField.tsx ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const ChartsField = ({ price30dHistorydata, priceMaxHistorydata, txVolumeData, tokenTxsChartData, }) => {
    let availableCharts = [];
    ...
    const CustomPriceTooltip = (props) => {
        ...
        if (active && payload && payload.length) {
            ...
            const price = (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(payload[1].payload.price);
            const volume = (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(payload[1].payload.totalVolume);
    ...
    const CustomPriceBar = (props) => {
        ...
        let fill = chartOption === 1 && date.getDay() === 1
            ? _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_dark
            : _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].primary_dark;
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.container, title: "Use arrow keys to navigate" },
        ...
        (availableCharts[chartOption] === "price30dHistorydata" ||
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_5__.ComposedChart, { data: availableCharts[chartOption] === "price30dHistorydata"
                    ? price30dHistorydata
                    : priceMaxHistorydata, margin: { top: 0, left: 0, right: 0, bottom: 0 } },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_6__.XAxis, { padding: { left: chartOption === 2 ? 24 : 12, right: 12 }, dataKey: "date", tickFormatter: (date, index) => {
                        if (availableCharts[chartOption] === "price30dHistorydata" &&
                            price30dHistorydata.length > 40) {
                            return "";
                        }
                        if (availableCharts[chartOption] === "price30dHistorydata" &&
                            date.getDay() === 1) {
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_10__.ReferenceLine, { y: availableCharts[chartOption] === "price30dHistorydata"
                        ? Math.max(...price30dHistorydata.map((dateData) => dateData.chartFormatPrice))
                        : Math.max(...priceMaxHistorydata.map((dateData) => dateData.chartFormatPrice)), stroke: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].primary_dark, strokeDasharray: "0 36 9 0", style: { display: "none" } },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_11__.Label, { value: `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(availableCharts[chartOption] === "price30dHistorydata"
                            ? Math.max(...price30dHistorydata.map((dateData) => dateData.price))
                            : Math.max(...priceMaxHistorydata.map((dateData) => dateData.price)))}`, position: "insideTopLeft", fill: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_light })),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_10__.ReferenceLine, { y: availableCharts[chartOption] === "price30dHistorydata"
                        ? Math.min(...price30dHistorydata.map((dateData) => dateData.chartFormatPrice))
                        : Math.min(...priceMaxHistorydata.map((dateData) => dateData.chartFormatPrice)), stroke: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].primary_dark, strokeDasharray: "0 36 9 0", style: { display: "none" } },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_11__.Label, { value: `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(availableCharts[chartOption] === "price30dHistorydata"
                            ? Math.min(...price30dHistorydata.map((dateData) => dateData.price))
                            : Math.min(...priceMaxHistorydata.map((dateData) => dateData.price)))}`, position: "insideBottomLeft", fill: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_light }))))),
        availableCharts[chartOption] === "txVolumeData" && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_4__.ResponsiveContainer, { width: "100%", height: "100%" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_5__.ComposedChart, { data: txVolumeData, margin: { top: 12, left: 24, right: 0, bottom: 0 } },
        ...
        availableCharts[chartOption] === "tokenTxsChartData" && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_4__.ResponsiveContainer, { width: "100%", height: "100%" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_5__.ComposedChart, { data: tokenTxsChartData, margin: { top: 14, left: 24, right: 0, bottom: 0 }, style: { cursor: "pointer" } },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(recharts__WEBPACK_IMPORTED_MODULE_6__.XAxis, { padding: { left: 12, right: 12 }, dataKey: "date", tickFormatter: (date, index) => {
...
/***/ "./src/components/CoinInfoField.tsx":
/*!******************************************!*\
  !*** ./src/components/CoinInfoField.tsx ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CoinInfoField": () => (/* binding */ CoinInfoField)
/* harmony export */ });
/* harmony import */ var _TitleField__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TitleField */ "./src/components/TitleField.tsx");
/* harmony import */ var _TickerField__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TickerField */ "./src/components/TickerField.tsx");
/* harmony import */ var _ChartsField__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ChartsField */ "./src/components/ChartsField.tsx");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _ValueField__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ValueField */ "./src/components/ValueField.tsx");
/* harmony import */ var _utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/amountFormatter */ "./src/utils/amountFormatter.ts");
/* harmony import */ var _ExpandableTextField__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ExpandableTextField */ "./src/components/ExpandableTextField.tsx");
/* harmony import */ var _SocialsFooter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./SocialsFooter */ "./src/components/SocialsFooter.tsx");
/* harmony import */ var _PriceBarField__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./PriceBarField */ "./src/components/PriceBarField.tsx");
/* harmony import */ var _ExchangesField__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ExchangesField */ "./src/components/ExchangesField.tsx");
...
const CoinInfoField = ({ coinInfo, tokenTxsChartData, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((react__WEBPACK_IMPORTED_MODULE_3___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: styles.topContainer },
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_TitleField__WEBPACK_IMPORTED_MODULE_0__["default"], { tokenTitle: coinInfo.name, title: "Use arrow keys to navigate" }),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_TickerField__WEBPACK_IMPORTED_MODULE_1__["default"], { ticker: coinInfo.symbol })),
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ChartsField__WEBPACK_IMPORTED_MODULE_2__["default"], { price30dHistorydata: coinInfo.price30dHistoryData, priceMaxHistorydata: coinInfo.priceMaxHistoryData, tokenTxsChartData: tokenTxsChartData }),
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: styles.bottomContainer },
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: styles.bottomMargin, title: "ATL / Price / ATH" },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_PriceBarField__WEBPACK_IMPORTED_MODULE_8__["default"], { allTimeLow: (_b = (_a = coinInfo.market_data) === null || _a === void 0 ? void 0 : _a.atl) === null || _b === void 0 ? void 0 : _b.usd, allTimeHigh: (_d = (_c = coinInfo.market_data) === null || _c === void 0 ? void 0 : _c.ath) === null || _d === void 0 ? void 0 : _d.usd, price: (_f = (_e = coinInfo.market_data) === null || _e === void 0 ? void 0 : _e.current_price) === null || _f === void 0 ? void 0 : _f.usd })),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: Object.assign(Object.assign({}, styles.dataBlocks), styles.bottomMargin) },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ValueField__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Circ. Supply", tooltipTitle: "/ Total supply", mainValue: ((_g = coinInfo.market_data) === null || _g === void 0 ? void 0 : _g.circulating_supply)
                        ? (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.amountFormatter)((_h = coinInfo.market_data) === null || _h === void 0 ? void 0 : _h.circulating_supply)
                        : "-", secondaryValue: ((_j = coinInfo.market_data) === null || _j === void 0 ? void 0 : _j.total_supply)
                        ? `/ ${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.amountFormatter)((_k = coinInfo.market_data) === null || _k === void 0 ? void 0 : _k.total_supply)}`
                        : "/ -" }),
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ValueField__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Market Cap", tooltipTitle: "# Rank", mainValue: ((_l = coinInfo.market_data) === null || _l === void 0 ? void 0 : _l.market_cap.usd)
                        ? `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.amountFormatter)((_m = coinInfo.market_data) === null || _m === void 0 ? void 0 : _m.market_cap.usd)}`
                        : "-", secondaryValue: coinInfo.market_cap_rank ? `#${coinInfo.market_cap_rank}` : "/ -" })),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: styles.bottomMargin },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ExchangesField__WEBPACK_IMPORTED_MODULE_9__["default"], { tickers: coinInfo.tickers })),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: styles.bottomMargin },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ExpandableTextField__WEBPACK_IMPORTED_MODULE_6__["default"], { text: (_o = coinInfo.description) === null || _o === void 0 ? void 0 : _o.en })),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_SocialsFooter__WEBPACK_IMPORTED_MODULE_7__.SocialsFooter, { coinInfo: coinInfo }))));
};
const styles = {
    topContainer: {
        padding: "0 12px",
...
/***/ "./src/components/ExchangesField.tsx":
/*!*******************************************!*\
  !*** ./src/components/ExchangesField.tsx ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _static_colors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../static/colors */ "./src/static/colors.tsx");
/* harmony import */ var _static_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../static/constants */ "./src/static/constants.tsx");
/* harmony import */ var _static_exchangeIcons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../static/exchangeIcons */ "./src/static/exchangeIcons.tsx");
/* harmony import */ var _utils_amountFormatter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/amountFormatter */ "./src/utils/amountFormatter.ts");
...
const ExchangesField = ({ tickers }) => {
    ...
    const formatExchangeInfo = (tickers) => {
        ...
        const exchangesFormatted = top15Tickers.map((obj) => {
            ...
            if ((quote === null || quote === void 0 ? void 0 : quote.length) > 5) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { key: Date.now(), style: {
        ...
        } }, formatExchangeInfo(tickers).map((exchange, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { key: exchange.id + exchange.quote + index, style: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, styles.exchangeWrapper), (index === 0 && styles.firstExchange)), (index === formatExchangeInfo(tickers).length - 1 &&
            styles.lastExchange)), { display: isExpanded || index === 0 ? "flex" : "none" }), (index === focusedOptionIndex && styles.exchangeWrapperFocused)) },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { display: "flex", alignItems: "center", cursor: "pointer" }, onClick: (event) => {
            ...
            }, onFocus: () => exchange.id.length && setFocusedOptionIndex(index), onBlur: () => exchange.id.length && setFocusedOptionIndex(-1), onMouseEnter: () => exchange.id.length && setFocusedOptionIndex(index), onMouseLeave: () => exchange.id.length && setFocusedOptionIndex(-1) },
            exchange.id ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: _static_exchangeIcons__WEBPACK_IMPORTED_MODULE_3__["default"][exchange.id] ||
                    "https://assets.coingecko.com/coins/images/5/small/dogecoin.png?1547792256", alt: exchange.exchangeName, style: styles.image })) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.image })),
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.tradingVolume }, exchange.tradingVolume
                ? (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_4__.amountFormatter)(exchange.tradingVolume)
                : ""),
            !isExpanded ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.staticText }, "/ 24h")) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.staticText }, exchange.quote))),
        index === 0 &&
            formatExchangeInfo(tickers).length > 1 &&
            (isExpanded ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: ExpandLessIcon, alt: "expand-less-icon", style: styles.arrowIcon, onClick: toggleExpanded })) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: ExpandMoreIcon, alt: "expand-more-icon", style: styles.arrowIcon, onClick: toggleExpanded }))))))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ExchangesField);
...
const ExpandableTextField = ({ text }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.expandableField },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.textFieldContainer },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.textField }, (text === null || text === void 0 ? void 0 : text.length) > 10
                ? formattedDescription(text)
                : "No description available")),
        (text === null || text === void 0 ? void 0 : text.length) > 10 && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.expandBtn, onClick: handleClick }, expanded ? "Collapse" : "Expand"))));
};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _static_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../static/constants */ "./src/static/constants.tsx");
/* harmony import */ var _HeaderMenuItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./HeaderMenuItem */ "./src/components/HeaderField/HeaderMenuItem.tsx");
/* harmony import */ var _OpenOverlayButton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./OpenOverlayButton */ "./src/components/HeaderField/OpenOverlayButton.tsx");
/* harmony import */ var _SearchBarField__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./SearchBarField */ "./src/components/HeaderField/SearchBarField.tsx");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
const styles = {
    ...
    searchResults: {
        ...
        borderBottomLeftRadius: _static_constants__WEBPACK_IMPORTED_MODULE_1__["default"].border_radius,
        borderBottomRightRadius: _static_constants__WEBPACK_IMPORTED_MODULE_1__["default"].border_radius,
    },
};
...
/***/ "./src/components/HeaderField/HeaderMenuItem.tsx":
/*!*******************************************************!*\
  !*** ./src/components/HeaderField/HeaderMenuItem.tsx ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "HeaderMenuItem": () => (/* binding */ HeaderMenuItem)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _static_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../static/constants */ "./src/static/constants.tsx");
/* harmony import */ var _static_colors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../static/colors */ "./src/static/colors.tsx");



const HeaderMenuItem = ({ tokenInfo, index, handleCoinOptionClick, setFocusedOptionIndex, focusedOptionIndex, }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { key: tokenInfo.id + index, style: index === focusedOptionIndex
        ...
        }, onFocus: () => tokenInfo.id.length && setFocusedOptionIndex(index), onBlur: () => tokenInfo.id.length && setFocusedOptionIndex(-1), onMouseEnter: () => tokenInfo.id.length && setFocusedOptionIndex(index), onMouseLeave: () => tokenInfo.id.length && setFocusedOptionIndex(-1) },
        tokenInfo.image ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: tokenInfo.image ||
                "https://assets.coingecko.com/coins/images/5/small/dogecoin.png?1547792256", alt: tokenInfo.name, style: styles.coinImage })) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.coinImage })),
        ...
        tokenInfo.marketCapRank &&
            (tokenInfo.marketCapRank === "NFT" ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.marketCapRank }, tokenInfo.marketCapRank)) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.marketCapRank },
                "#",
                tokenInfo.marketCapRank)))));
};
const styles = {
    ...
    coinSearchInfoFocus: {
        boxShadow: `inset 0 0 4px 3px rgba(255, 255, 255, 0.5)`,
        outline: "none",
        borderRadius: _static_constants__WEBPACK_IMPORTED_MODULE_1__["default"].border_radius_small,
    },
    coinImage: {
        width: 22,
        height: 22,
    ...
    exchangeName: {
        paddingLeft: 12,
        width: 100,
        color: _static_colors__WEBPACK_IMPORTED_MODULE_2__["default"].white_medium,
        fontSize: _static_constants__WEBPACK_IMPORTED_MODULE_1__["default"].font_medium,
        fontWeight: _static_constants__WEBPACK_IMPORTED_MODULE_1__["default"].font_weight_medium,
        whiteSpace: "nowrap",
        overflow: "hidden",
        textOverflow: "ellipsis",
    },
    marketCapRank: {
        paddingLeft: 6,
        width: 40,
        color: _static_colors__WEBPACK_IMPORTED_MODULE_2__["default"].accent_medium,
        fontSize: _static_constants__WEBPACK_IMPORTED_MODULE_1__["default"].font_small,
        fontWeight: _static_constants__WEBPACK_IMPORTED_MODULE_1__["default"].font_weight_medium,
    },
};
...
/***/ "./src/components/HeaderField/OpenOverlayButton.tsx":
/*!**********************************************************!*\
  !*** ./src/components/HeaderField/OpenOverlayButton.tsx ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OpenOverlayButton": () => (/* binding */ OpenOverlayButton)
/* harmony export */ });
/* harmony import */ var _static_colors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../static/colors */ "./src/static/colors.tsx");
...
const OpenOverlayButton = ({ setMenuIsOpen }) => {
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: styles.menuIconBlock, title: "Menu", onClick: () => setMenuIsOpen(true) },
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_mui_icons_material_Menu__WEBPACK_IMPORTED_MODULE_3__["default"], { style: { fontSize: 24, color: _static_colors__WEBPACK_IMPORTED_MODULE_0__["default"].secondary_medium } })));
};
const styles = {
    menuIconBlock: {
        width: 40,
        height: 40,
        borderRadius: _static_constants__WEBPACK_IMPORTED_MODULE_2__["default"].border_radius,
        backgroundColor: _static_colors__WEBPACK_IMPORTED_MODULE_0__["default"].primary_dark,
        display: "flex",
        justifyContent: "center",
        alignItems: "center",
        cursor: "pointer",
...
/***/ "./src/components/HeaderField/SearchBarField.tsx":
/*!*******************************************************!*\
  !*** ./src/components/HeaderField/SearchBarField.tsx ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SearchBarField": () => (/* binding */ SearchBarField)
/* harmony export */ });
...
const SearchBarField = ({ mainLogo, inputRef, isExpanded, setIsExpanded, setDisplayResults, setSearchInput, searchInput, isLoadingError, }) => {
    ...
    const handleDisplayApiFeedback = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (API_KEY === _static_constants__WEBPACK_IMPORTED_MODULE_0__.SHARED_API_KEY_COINGECKO) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement((react__WEBPACK_IMPORTED_MODULE_2___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: Object.assign(Object.assign({}, styles.searchbar), { borderBottomLeftRadius: isExpanded ? 0 : _static_constants__WEBPACK_IMPORTED_MODULE_0__["default"].border_radius, borderBottomRightRadius: isExpanded ? 0 : _static_constants__WEBPACK_IMPORTED_MODULE_0__["default"].border_radius }) },
...
const styles = {
    searchbar: {
        ...
        width: 202,
        height: 40,
        borderRadius: _static_constants__WEBPACK_IMPORTED_MODULE_0__["default"].border_radius,
        backgroundColor: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].primary_dark,
        display: "flex",
        alignItems: "center",
        position: "relative",
...
/***/ "./src/components/NftInfoField.tsx":
/*!*****************************************!*\
  !*** ./src/components/NftInfoField.tsx ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "NftInfoField": () => (/* binding */ NftInfoField)
/* harmony export */ });
/* harmony import */ var _TitleField__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TitleField */ "./src/components/TitleField.tsx");
/* harmony import */ var _TickerField__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TickerField */ "./src/components/TickerField.tsx");
/* harmony import */ var _ChartsField__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ChartsField */ "./src/components/ChartsField.tsx");
...
// Use props type in component
const NftInfoField = ({ nftInfo, txVolumeChartData, }) => {
    var _a, _b, _c, _d;
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((react__WEBPACK_IMPORTED_MODULE_3___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: styles.topContainer },
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_TitleField__WEBPACK_IMPORTED_MODULE_0__["default"], { tokenTitle: nftInfo.name, title: "Use arrow keys to navigate" }),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_TickerField__WEBPACK_IMPORTED_MODULE_1__["default"], { ticker: nftInfo.symbol })),
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ChartsField__WEBPACK_IMPORTED_MODULE_2__["default"], { txVolumeData: txVolumeChartData }),
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: styles.bottomContainer },
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: Object.assign(Object.assign({}, styles.dataBlocks), styles.bottomMargin) },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ValueField__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Floor", tooltipTitle: "24h change %", mainValue: `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.amountFormatter)((_a = nftInfo.floor_price) === null || _a === void 0 ? void 0 : _a.usd) || "-"}`, secondaryValue: `${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.percentageFormatter)(nftInfo.floor_price_in_usd_24h_percentage_change)}%` }),
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ValueField__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Native", tooltipTitle: "Native floor/ platform", mainValue: `${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.amountFormatter)((_b = nftInfo.floor_price) === null || _b === void 0 ? void 0 : _b.native_currency) || "-"}`, secondaryValue: nftInfo.native_currency
                        ? (nftInfo.native_currency.charAt(0).toUpperCase() +
                            nftInfo.native_currency.slice(1)).substring(0, 8)
                        : "-" })),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: Object.assign(Object.assign({}, styles.dataBlocks), styles.bottomMargin) },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ValueField__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Total supply", mainValue: nftInfo.total_supply ? `${nftInfo.total_supply}` : "-" }),
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ValueField__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Unique owners", tooltipTitle: "24h change %", mainValue: nftInfo.number_of_unique_addresses
                        ? (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.numberFormatter)(nftInfo.number_of_unique_addresses)
                        : "-", secondaryValue: nftInfo.number_of_unique_addresses_24h_percentage_change
                        ? `${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.percentageFormatter)(nftInfo.number_of_unique_addresses_24h_percentage_change)}%`
                        : "" })),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: Object.assign(Object.assign({}, styles.dataBlocks), styles.bottomMargin) },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ValueField__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Market Cap", mainValue: ((_c = nftInfo === null || nftInfo === void 0 ? void 0 : nftInfo.market_cap) === null || _c === void 0 ? void 0 : _c.usd)
                        ? `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.amountFormatter)((_d = nftInfo === null || nftInfo === void 0 ? void 0 : nftInfo.market_cap) === null || _d === void 0 ? void 0 : _d.usd)}`
                        : "-" }),
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ValueField__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Volume", tooltipTitle: "24h change %", mainValue: nftInfo.volume_24h.usd
                        ? `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.amountFormatter)(nftInfo.volume_24h.usd)}`
                        : "-", secondaryValue: nftInfo.volume_in_usd_24h_percentage_change
                        ? `${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.percentageFormatter)(nftInfo.volume_in_usd_24h_percentage_change)}%`
                        : "" })),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: styles.bottomMargin },
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ExpandableTextField__WEBPACK_IMPORTED_MODULE_6__["default"], { text: nftInfo.description })),
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_SocialsFooter__WEBPACK_IMPORTED_MODULE_7__.SocialsFooter, { coinInfo: nftInfo }))));
};
const styles = {
    topContainer: {
        padding: "0 12px",
...
/***/ "./src/components/OverlayMenu/CoingeckoApiField.tsx":
/*!**********************************************************!*\
  !*** ./src/components/OverlayMenu/CoingeckoApiField.tsx ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CoingeckoApiField": () => (/* binding */ CoingeckoApiField)
/* harmony export */ });
...
const CoingeckoApiField = ({}) => {
    const [coingeckoApiKey, setCoingeckoApiKey] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        checkStorage();
    }, []);
    const checkStorage = () => __awaiter(void 0, void 0, void 0, function* () {
        const coingeckoApiKeyStorage = yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_3__.getCoingeckoApiKeyStorage)();
        if (coingeckoApiKeyStorage) {
            setCoingeckoApiKey(coingeckoApiKeyStorage);
        }
    });
    const handleCoingeckoApiKey = () => __awaiter(void 0, void 0, void 0, function* () {
        if ((coingeckoApiKey === null || coingeckoApiKey === void 0 ? void 0 : coingeckoApiKey.length) > 22) {
            yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_3__.setCoingeckoApiKeyStorage)(coingeckoApiKey);
        }
    });
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: styles.sectionHeader }, "Free CoinGecko API Key"),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: styles.explanationSubtext },
            "It is required to use your CoinGecko API key. You can get one for free ",
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", { href: "https://www.coingecko.com/en/api/pricing", target: "_blank", style: { color: "white" } }, "here"),
            "; \nCreate a Demo Account -> Developer Dashboard -> Copy key below."),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: styles.coingeckoApiInputField },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("input", { type: "password", value: coingeckoApiKey, onChange: (e) => setCoingeckoApiKey(e.target.value), style: styles.coingeckoApiInput, placeholder: `CoinGecko API Key` }),
...
const styles = {
    sectionHeader: {
        ...
        margin: "18px 0 3px 0 ",
        fontSize: "16px",
        color: _static_colors__WEBPACK_IMPORTED_MODULE_0__["default"].white_medium,
    },
    explanationSubtext: {
        color: _static_colors__WEBPACK_IMPORTED_MODULE_0__["default"].accent_medium,
        fontSize: "12px",
        marginBottom: "12px",
        textAlign: "center",
    },
    ...
    coingeckoApiInput: {
        ...
        borderRadius: _static_constants__WEBPACK_IMPORTED_MODULE_2__["default"].border_radius,
        fontSize: "12px",
        color: _static_colors__WEBPACK_IMPORTED_MODULE_0__["default"].primary_medium,
        border: "none",
        outline: "none",
    },
    inputContainerSaveButton: {
        ...
        borderRadius: _static_constants__WEBPACK_IMPORTED_MODULE_2__["default"].border_radius,
        cursor: "pointer",
        backgroundColor: _static_colors__WEBPACK_IMPORTED_MODULE_0__["default"].secondary_dark,
        border: "none",
        textAlign: "center",
    },
};
...
/***/ "./src/components/OverlayMenu/OverlayMenu.tsx":
/*!****************************************************!*\
  !*** ./src/components/OverlayMenu/OverlayMenu.tsx ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _static_colors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../static/colors */ "./src/static/colors.tsx");
/* harmony import */ var _static_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../static/constants */ "./src/static/constants.tsx");
/* harmony import */ var _mui_icons_material_QuestionAnswer__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @mui/icons-material/QuestionAnswer */ "./node_modules/@mui/icons-material/QuestionAnswer.js");
...
/* harmony import */ var _mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @mui/material/ToggleButton */ "./node_modules/@mui/material/ToggleButton/ToggleButton.js");
/* harmony import */ var _utils_storage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/storage */ "./src/utils/storage.ts");
...
/* harmony import */ var _SearchResultNftAmountSettingsField__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./SearchResultNftAmountSettingsField */ "./src/components/OverlayMenu/SearchResultNftAmountSettingsField.tsx");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
const OverlayMenu = ({ menuIsOpen, setMenuIsOpen, handleFetchTokenInfo, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: menuIsOpen
            ? Object.assign(Object.assign({}, styles.overlayMenu), styles.overlayMenuOpen) : styles.overlayMenu },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: menuIsOpen
                ? Object.assign(Object.assign({}, styles.menuContent), styles.menuContentOpen) : styles.menuContent },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.menuCloseButton },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Close__WEBPACK_IMPORTED_MODULE_9__["default"], { style: { fontSize: 24, color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].secondary_medium }, onClick: () => setMenuIsOpen(false) })),
            menuIsOpen && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.scrollContainer },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_PortfolioBlock__WEBPACK_IMPORTED_MODULE_6__["default"], { loading: loading, portfolioData: portfolioData, setPortfolioData: setPortfolioData, handleFetchTokenInfo: handleFetchTokenInfo }),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_WalletTrackerBlock__WEBPACK_IMPORTED_MODULE_5__["default"], null),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.sectionHeader }, "Tweet to Me!"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.explanationSubtext }, "Using the extension? Let me know! I'm always looking for feedback"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_ToggleButton__WEBPACK_IMPORTED_MODULE_10__["default"], { value: "question", style: styles.togglePrefButton, onClick: handleSupportClick },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_QuestionAnswer__WEBPACK_IMPORTED_MODULE_11__["default"], { style: {
                            fontSize: 24,
                            cursor: "pointer",
                            color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].white_medium,
                        } })),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_SearchResultNftAmountSettingsField__WEBPACK_IMPORTED_MODULE_8__.SearchResultNftAmountSettingsField, null),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CoingeckoApiField__WEBPACK_IMPORTED_MODULE_7__.CoingeckoApiField, null))),
...
/***/ "./src/components/OverlayMenu/PortfolioBlock.tsx":
/*!*******************************************************!*\
  !*** ./src/components/OverlayMenu/PortfolioBlock.tsx ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _PortfolioItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./PortfolioItem */ "./src/components/OverlayMenu/PortfolioItem.tsx");
/* harmony import */ var _PortfolioHeader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./PortfolioHeader */ "./src/components/OverlayMenu/PortfolioHeader.tsx");
...
const PortfolioBlock = ({ portfolioData, setPortfolioData, loading, handleFetchTokenInfo, }) => {
    const [showInputField, setShowInputField] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
    const [inputAmount, setInputAmount] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
    const [clickedCoinId, setClickedCoinId] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
    const [clickedCoinTicker, setClickedCoinTicker] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
    ...
    const handleRemoveCoinButton = () => {
        if (removeCoinPress) {
            ...
            (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.removePortfolioCoinStorage)(clickedCoinId);
    ...
    const handlePortfolioCoinPress = (coinInfoId, coinTicker) => {
    ...
    const handleSaveAmountInput = () => {
        const updatedPortfolioData = portfolioData.map((coinInfo) => {
            if (coinInfo.id === clickedCoinId) {
                return Object.assign(Object.assign({}, coinInfo), { amount: parseFloat(inputAmount) });
            }
            return coinInfo;
        });
        setPortfolioData(updatedPortfolioData);
        (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.changePortfolioCoinAmountStorage)(clickedCoinId, parseFloat(inputAmount));
        setInputAmount("");
        setShowInputField(false);
    };
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        calculatePortfolioValue() > 0 ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioValueField },
            "$",
            (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(calculatePortfolioValue()))) : loading ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.emptyPortfolioValueField }, "Loading..")) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.emptyPortfolioValueField }, "Click on coin to add amount")),
        showInputField && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.inputContainer },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.inputContainerSaveButton, onClick: handleSaveAmountInput },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Save__WEBPACK_IMPORTED_MODULE_7__["default"], { style: { fontSize: 14, color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].white_medium } })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.inputContainerDeleteButton, onClick: handleRemoveCoinButton },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Delete__WEBPACK_IMPORTED_MODULE_8__["default"], { style: { fontSize: 14, color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].white_medium } }),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioItemField },
            (portfolioData === null || portfolioData === void 0 ? void 0 : portfolioData.length) > 0 && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_PortfolioHeader__WEBPACK_IMPORTED_MODULE_6__.PortfolioHeader, null),
            (portfolioData === null || portfolioData === void 0 ? void 0 : portfolioData.length) > 0 ? (portfolioData
                .sort((a, b) => b.amount * b.price - a.amount * a.price)
                .map((coinInfo) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_PortfolioItem__WEBPACK_IMPORTED_MODULE_5__.PortfolioItem, { key: coinInfo.id, coinInfo: coinInfo, handlePortfolioCoinPress: handlePortfolioCoinPress })))) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.noCoinsText }, "No coins in portfolio, add coins at the bottom of a page")))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PortfolioBlock);
const styles = {
    portfolioSectionTitle: {
        marginTop: _static_constants__WEBPACK_IMPORTED_MODULE_2__["default"].default_padding,
        marginBottom: "2px",
        color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].accent_medium,
        fontSize: _static_constants__WEBPACK_IMPORTED_MODULE_2__["default"].font_nano,
...
/***/ "./src/components/OverlayMenu/PortfolioHeader.tsx":
/*!********************************************************!*\
  !*** ./src/components/OverlayMenu/PortfolioHeader.tsx ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PortfolioHeader": () => (/* binding */ PortfolioHeader)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _static_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../static/constants */ "./src/static/constants.tsx");
...
const PortfolioHeader = () => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioHeader },
...
const styles = {
    ...
    portfolioHeaderValue: {
        ...
        marginLeft: "14px",
        color: _static_colors__WEBPACK_IMPORTED_MODULE_2__["default"].accent_medium,
        fontSize: _static_constants__WEBPACK_IMPORTED_MODULE_1__["default"].font_micro,
        fontWeight: _static_constants__WEBPACK_IMPORTED_MODULE_1__["default"].font_weight_medium,
    },
    portfolioItemImage: {
        width: "22px",
...
/***/ "./src/components/OverlayMenu/PortfolioItem.tsx":
/*!******************************************************!*\
  !*** ./src/components/OverlayMenu/PortfolioItem.tsx ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PortfolioItem": () => (/* binding */ PortfolioItem)
/* harmony export */ });
/* harmony import */ var _utils_amountFormatter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/amountFormatter */ "./src/utils/amountFormatter.ts");
/* harmony import */ var _static_colors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../static/colors */ "./src/static/colors.tsx");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _static_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../static/constants */ "./src/static/constants.tsx");




const PortfolioItem = ({ coinInfo, handlePortfolioCoinPress }) => {
    var _a;
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { key: coinInfo.id },
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: styles.portfolioItem, onClick: () => handlePortfolioCoinPress(coinInfo.id, coinInfo.ticker) },
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("img", { style: styles.portfolioItemImage, src: coinInfo.iconUrl, alt: coinInfo.ticker }),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: styles.portfolioItemDataField },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: styles.portfolioItemTopRow },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", { style: styles.portfolioItemValue },
                        "$",
                        (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_0__.amountFormatter)(coinInfo.price)),
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: styles.amountText }, coinInfo.amount > 0 ? (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_0__.amountFormatter)(coinInfo.amount) : "-"),
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", { style: styles.portfolioItemValue }, coinInfo.amount > 0
                        ? `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_0__.amountFormatter)(coinInfo.price * coinInfo.amount)}`
                        : "-")),
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: styles.portfolioItemBottomRow },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", { style: Object.assign(Object.assign({}, styles.portfolioItemValue), styles.tickerText) }, coinInfo.ticker.toUpperCase()),
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: styles.portfolioItemValue }),
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", { style: Object.assign(Object.assign({}, styles.portfolioItemValue), { color: coinInfo.usd24Change > 0
                                ? _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].green_medium
                                : _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].red_medium }) }, `${coinInfo.usd24Change ? (_a = coinInfo.usd24Change) === null || _a === void 0 ? void 0 : _a.toFixed(1) : "-"}%`)))),
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: styles.portfolioItemDivider })));
};
const styles = {
    portfolioItem: {
        height: "32px",
    ...
    portfolioItemTopRow: {
        height: "16px",
        fontSize: _static_constants__WEBPACK_IMPORTED_MODULE_3__["default"].font_small,
        display: "flex",
        alignItems: "flex-start",
        fontWeight: _static_constants__WEBPACK_IMPORTED_MODULE_3__["default"].font_weight_large,
    },
    portfolioItemBottomRow: {
        height: "16px",
        fontSize: _static_constants__WEBPACK_IMPORTED_MODULE_3__["default"].font_micro,
        display: "flex",
        alignItems: "flex-end",
        fontWeight: _static_constants__WEBPACK_IMPORTED_MODULE_3__["default"].font_weight_medium,
    },
    portfolioItemValue: {
        width: "55px",
        marginLeft: "14px",
...
/***/ "./src/components/OverlayMenu/SearchResultNftAmountSettingsField.tsx":
/*!***************************************************************************!*\
  !*** ./src/components/OverlayMenu/SearchResultNftAmountSettingsField.tsx ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SearchResultNftAmountSettingsField": () => (/* binding */ SearchResultNftAmountSettingsField)
/* harmony export */ });
...
const SearchResultNftAmountSettingsField = () => {
    const [searchResultNftAmount, setSearchResultNftAmount] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(3);
    const checkStorage = () => __awaiter(void 0, void 0, void 0, function* () {
        const searchResultNftAmountStorage = yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.getSearchResultNftAmountStorage)();
        setSearchResultNftAmount(searchResultNftAmountStorage);
    });
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        checkStorage();
    }, []);
    const handleSearchResultNftAmount = (newSearchResultNftAmount) => {
        if (newSearchResultNftAmount !== null) {
            setSearchResultNftAmount(newSearchResultNftAmount);
            (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.setSearchResultNftAmountStorage)(newSearchResultNftAmount);
        }
    };
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: styles.sectionHeader }, "Search Results"),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: styles.explanationSubtext }, `Max number of Nfts from 13 results (${searchResultNftAmount})`),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_mui_material_Box__WEBPACK_IMPORTED_MODULE_3__["default"], { sx: { width: 180 } },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_mui_material_Slider__WEBPACK_IMPORTED_MODULE_4__["default"], { size: "small", "aria-label": "Max Nfts out of 13 search results", value: searchResultNftAmount, valueLabelDisplay: "auto", onChange: (event, newTokenNftRatio) => {
                    ...
                    {
                        value: 2,
                        label: react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { style: styles.sliderMark }, "2 Nfts"),
                    },
                    {
                        value: 11,
                        label: react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { style: styles.sliderMark }, "11 Nfts"),
                    },
                ], min: 2, max: 11, style: { color: _static_colors__WEBPACK_IMPORTED_MODULE_0__["default"].white_medium } }))));
};
const styles = {
    sectionHeader: {
        fontWeight: "bold",
...
/***/ "./src/components/OverlayMenu/WalletTrackerBlock.tsx":
/*!***********************************************************!*\
  !*** ./src/components/OverlayMenu/WalletTrackerBlock.tsx ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _mui_icons_material_PlaylistAdd__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @mui/icons-material/PlaylistAdd */ "./node_modules/@mui/icons-material/PlaylistAdd.js");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
const WalletTrackerBlock = ({}) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.explanationSubtext }, "Get notified when account creates tx"),
        (trackedAccounts === null || trackedAccounts === void 0 ? void 0 : trackedAccounts.length) > 0 ? (trackedAccounts.map((account) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { key: `${account.name}-${account.address}`, style: styles.accountItemContainer },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.valueItems },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.accountItemName, onClick: () => handleOpenTab(`https://etherscan.io/address/${account.address}`) }, account.name),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.accountItemAddress, onClick: () => handleOpenTab(`https://etherscan.io/address/${account.address}`) }, (0,_utils_formatAddressShort__WEBPACK_IMPORTED_MODULE_6__.formatAddressShort)(account.address))),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.newAccountTrackInputField },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.trackAccountInputContainer },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { type: "text", value: trackAccountNameInput, onChange: (e) => setTrackAccountNameInput(e.target.value), style: styles.trackNameInputField, placeholder: `Label` })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.trackAccountInputContainer },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.trackAccountInputContainer },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.inputContainerSaveButton, onClick: handleSaveNewTrackAddress },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_PlaylistAdd__WEBPACK_IMPORTED_MODULE_8__["default"], { style: { fontSize: 14, color: _static_colors__WEBPACK_IMPORTED_MODULE_1__["default"].white_medium } })))),
...
/***/ "./src/components/PriceBarField.tsx":
/*!******************************************!*\
  !*** ./src/components/PriceBarField.tsx ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const PriceBarField = ({ allTimeLow, allTimeHigh, price, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.container },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.allTimeLow },
            "$",
            (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(allTimeLow)),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.price },
            "$",
            (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(price)),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.allTimeHigh },
            "$",
            (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_3__.amountFormatter)(allTimeHigh))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PriceBarField);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SocialsFooter": () => (/* binding */ SocialsFooter)
/* harmony export */ });
/* harmony import */ var _SocialsNumberField__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SocialsNumberField */ "./src/components/SocialsNumberField.tsx");
/* harmony import */ var _mui_icons_material_PlaylistAdd__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @mui/icons-material/PlaylistAdd */ "./node_modules/@mui/icons-material/PlaylistAdd.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _static_colors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../static/colors */ "./src/static/colors.tsx");
/* harmony import */ var _utils_storage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/storage */ "./src/utils/storage.ts");
...
const SocialsFooter = ({ coinInfo }) => {
    ...
    const checkStorage = () => __awaiter(void 0, void 0, void 0, function* () {
        const portfolioDataStorage = yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_3__.getPortfolioDataStorage)();
        const coinIds = [];
        portfolioDataStorage === null || portfolioDataStorage === void 0 ? void 0 : portfolioDataStorage.forEach((coinInfo) => {
            coinIds.push(coinInfo.id);
        });
    ...
    const addToPortfolio = () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_3__.setPortfolioDataStorage)({
            id: coinInfo.id,
...
const styles = {
    ...
    addToPortfolioIcon: {
        ...
        justifyContent: "flex-start",
        alignItems: "center",
        backgroundColor: _static_colors__WEBPACK_IMPORTED_MODULE_2__["default"].primary_dark,
    },
    iconStyling: {
        fontSize: 20,
        color: _static_colors__WEBPACK_IMPORTED_MODULE_2__["default"].white_medium,
...
/***/ "./src/components/SocialsNumberField.tsx":
/*!***********************************************!*\
  !*** ./src/components/SocialsNumberField.tsx ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const SocialsNumberField = ({ image, mainValue, link, title, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: Object.assign({}, styles.container), onClick: handleOpenTab, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false), title: title },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: image, alt: "Social image", style: Object.assign(Object.assign({}, styles.image), (isHovered && styles.imageFocused)) }),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SocialsNumberField);


/***/ }),

/***/ "./src/components/TickerField.tsx":
/*!****************************************!*\
  !*** ./src/components/TickerField.tsx ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TickerField = ({ ticker }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.container },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.tickerText }, ticker.toUpperCase())));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TickerField);
...
const TitleField = ({ tokenTitle, title }) => {
    const styles = {
        container: {
            height: _static_constants__WEBPACK_IMPORTED_MODULE_2__["default"].font_large,
            paddingTop: _static_constants__WEBPACK_IMPORTED_MODULE_2__["default"].default_padding,
            paddingBottom: _static_constants__WEBPACK_IMPORTED_MODULE_2__["default"].default_padding,
            textAlign: "center",
            fontFamily: "Open Sans, sans-serif",
            fontSize: _static_constants__WEBPACK_IMPORTED_MODULE_2__["default"].font_large,
...
const ValueField = ({ title, mainValue, secondaryValue, tooltipTitle, }) => {
    const styles = {
        rectangle: {
            display: "flex",
            flexDirection: "column",
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.rectangle, title: tooltipTitle },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.values },
            ...
            secondaryValue && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: styles.secondaryValue }, secondaryValue)))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ValueField);
...
/* harmony import */ var _components_TitleField__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/TitleField */ "./src/components/TitleField.tsx");
/* harmony import */ var _components_OverlayMenu_OverlayMenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/OverlayMenu/OverlayMenu */ "./src/components/OverlayMenu/OverlayMenu.tsx");
/* harmony import */ var _components_HeaderField_HeaderField__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/HeaderField/HeaderField */ "./src/components/HeaderField/HeaderField.tsx");
/* harmony import */ var _components_ChartsField__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/ChartsField */ "./src/components/ChartsField.tsx");
/* harmony import */ var _components_TickerField__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/TickerField */ "./src/components/TickerField.tsx");
/* harmony import */ var _api_getTrendingCoins__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../api/getTrendingCoins */ "./src/api/getTrendingCoins.ts");
/* harmony import */ var _api_fetchDetailedNftInfo__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../api/fetchDetailedNftInfo */ "./src/api/fetchDetailedNftInfo.ts");
/* harmony import */ var _api_fetchDetailedTokenInfo__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../api/fetchDetailedTokenInfo */ "./src/api/fetchDetailedTokenInfo.ts");
...
const App = () => {
    ...
    const [isOverlayOpen, setIsOverlayOpen] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
    ...
    const handleStartupInfo = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const homeCoinStorage = yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_11__.getHomeCoinStorage)();
        if (homeCoinStorage === null || homeCoinStorage === void 0 ? void 0 : homeCoinStorage.id) {
            handleFetchTokenInfo(homeCoinStorage.id, homeCoinStorage === null || homeCoinStorage === void 0 ? void 0 : homeCoinStorage.nft);
        }
        else {
            handleFetchTokenInfo("bitcoin", false); // default to corn
        }
        const trendingCoins = yield (0,_api_getTrendingCoins__WEBPACK_IMPORTED_MODULE_8__.getTrendingCoins)();
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.container },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.headerContainer },
            ...
            !(nftInfo === null || nftInfo === void 0 ? void 0 : nftInfo.name) && !(coinInfo === null || coinInfo === void 0 ? void 0 : coinInfo.name) && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_ChartsField__WEBPACK_IMPORTED_MODULE_6__["default"], null))),
            (coinInfo === null || coinInfo === void 0 ? void 0 : coinInfo.name) && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_CoinInfoField__WEBPACK_IMPORTED_MODULE_13__.CoinInfoField, { coinInfo: coinInfo, tokenTxsChartData: tokenTxsChartData })),
            (nftInfo === null || nftInfo === void 0 ? void 0 : nftInfo.name) && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_NftInfoField__WEBPACK_IMPORTED_MODULE_12__.NftInfoField, { nftInfo: nftInfo, txVolumeChartData: txVolumeChartData })))));
};
const styles = {
    headerContainer: {
        padding: "0px 12px",
...
const CACHE_TIME_SHORT = 600000; // 10 minutes
...
/* harmony export */   "percentageFormatter": () => (/* binding */ percentageFormatter)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "formatChartData": () => (/* binding */ formatChartData)
/* harmony export */ });
...
/***/ "./src/utils/logTrendingCoinsSocialsPost.ts":
/*!**************************************************!*\
  !*** ./src/utils/logTrendingCoinsSocialsPost.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "logTrendingCoinsSocialsPost": () => (/* binding */ logTrendingCoinsSocialsPost)
/* harmony export */ });
const logTrendingCoinsSocialsPost = (trendingCoins) => {
    let trendingTickers = "Top Searched Coins of the Day\n";
    trendingCoins.coins.forEach((coin) => {
        trendingTickers =
            trendingTickers +
                `- ${coin.item.name}, $${coin.item.symbol.toUpperCase()} #${coin.item.market_cap_rank}\n`;
    });
    trendingTickers =
        trendingTickers +
...
/* harmony export */   "getCoinPricesDataStorage": () => (/* binding */ getCoinPricesDataStorage),
/* harmony export */   "getCoingeckoApiKeyStorage": () => (/* binding */ getCoingeckoApiKeyStorage),
...
/* harmony export */   "getStoredCoinDataStorage": () => (/* binding */ getStoredCoinDataStorage),
/* harmony export */   "getStoredCoinPriceHistoryData": () => (/* binding */ getStoredCoinPriceHistoryData),
/* harmony export */   "getTrackedAccountsStorage": () => (/* binding */ getTrackedAccountsStorage),
/* harmony export */   "getTrendingCoinsStorage": () => (/* binding */ getTrendingCoinsStorage),
/* harmony export */   "removePortfolioCoinStorage": () => (/* binding */ removePortfolioCoinStorage),
/* harmony export */   "setCoinPricesDataStorage": () => (/* binding */ setCoinPricesDataStorage),
/* harmony export */   "setCoingeckoApiKeyStorage": () => (/* binding */ setCoingeckoApiKeyStorage),
...
/* harmony export */   "setStoredCoinDataStorage": () => (/* binding */ setStoredCoinDataStorage),
/* harmony export */   "setStoredCoinPriceHistoryDataStorage": () => (/* binding */ setStoredCoinPriceHistoryDataStorage),
...
// SETTERS
function setTrendingCoinsStorage(trendingCoins) {
    return __awaiter(this, void 0, void 0, function* () {
        // get time of now
        const currentTime = new Date().getTime();
        try {
...
function setCoinPricesDataStorage(coinPrices, coinIds) {
    return __awaiter(this, void 0, void 0, function* () {
        // get time of now
        const currentTime = new Date().getTime();
        try {
...
function setStoredCoinPriceHistoryDataStorage(coinPrices, coinId, chartRange) {
    return __awaiter(this, void 0, void 0, function* () {
        const currentTime = new Date().getTime();
        try {
            return new Promise((resolve) => {
...
function setStoredCoinDataStorage(storedCoin, coinId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const currentTime = new Date().getTime();
            return new Promise((resolve) => {
...
function setCoingeckoApiKeyStorage(coingeckoApiKey) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return new Promise((resolve) => {
...
// GETTERS
function getTrendingCoinsStorage() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield new Promise((resolve) => {
            chrome.storage.local.get(["trendingCoinsData"], (res) => {
                if (res === null || res === void 0 ? void 0 : res.trendingCoinsData) {
...
function getStoredCoinPriceHistoryData() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield new Promise((resolve) => {
            chrome.storage.local.get(["storedCoinPriceHistoryData"], (res) => {
                if (res === null || res === void 0 ? void 0 : res.storedCoinPriceHistoryData) {
...
function getCoinPricesDataStorage() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield new Promise((resolve) => {
            chrome.storage.local.get(["coinPricesData"], (res) => {
                if (res === null || res === void 0 ? void 0 : res.coinPricesData) {
...
function getStoredCoinDataStorage() {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => {
            chrome.storage.local.get(["storedCoinData"], (res) => {
                if (res === null || res === void 0 ? void 0 : res.storedCoinData) {
...
function getCoingeckoApiKeyStorage() {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => {
            chrome.storage.local.get(["coingeckoApiKey"], (res) => __awaiter(this, void 0, void 0, function* () {
                if (res === null || res === void 0 ? void 0 : res.coingeckoApiKey) {
...
module.exports = __webpack_require__.p + "2146c65a8a41f6ba1be3.png";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkCrypto_Tracker_Blockchain_Crypto_Explorer"] = self["webpackChunkCrypto_Tracker_Blockchain_Crypto_Explorer"] || [];
