...
const HeaderBlock = ({ mainLogo, setCoinInfo, setNftInfo, setTxVolumeChartData, setTokenTxsChartData, setMenuIsOpen }) => {
    ...
    function getTokenTxChartData(platformId, contractAddress, tokenValue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const nftTxsData = yield (0,_utils_api__WEBPACK_IMPORTED_MODULE_3__.fetchTokenTxs)(domain, contractAddress, 10000);
            if (nftTxsData.status !== "0" && nftTxsData.result) {
                const arrayWithIndices = nftTxsData.result.map((item, index) => (Object.assign(Object.assign({}, item), { index })));
...
/* harmony import */ var _components_ExpandableTextField__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/ExpandableTextField */ "./src/components/ExpandableTextField.tsx");
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.bottomContainer },
            (coinInfo === null || coinInfo === void 0 ? void 0 : coinInfo.name) &&
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.bottomMargin },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_ExpandableTextField__WEBPACK_IMPORTED_MODULE_6__["default"], { text: (_q = coinInfo.description) === null || _q === void 0 ? void 0 : _q.en })),
