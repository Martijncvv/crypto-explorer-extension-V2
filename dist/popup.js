...
const HeaderBlock = ({ mainLogo, setCoinInfo, setNftInfo, setTxVolumeChartData, setTokenTxsChartData, setMenuIsOpen, }) => {
    ...
    const checkStorage = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const selectedTokenStorage = yield (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.getSelectedTokenStorage)();
        if (selectedTokenStorage) {
            setSearchInput(selectedTokenStorage);
            searchCoinNames(selectedTokenStorage);
            (0,_utils_storage__WEBPACK_IMPORTED_MODULE_4__.setSelectedTokenStorage)("");
        }
        else {
...
const OverlayMenu = ({ menuIsOpen, setMenuIsOpen, coinInfo, nftInfo, }) => {
    ...
    const handleSaveAmountInput = () => {
        ...
        (0,_utils_storage__WEBPACK_IMPORTED_MODULE_3__.changePortfolioCoinAmountStorage)(clickedCoinId, parseFloat(inputAmount));
        setInputAmount("");
    ...
    const handleRemoveCoinButton = () => {
        if (removeCoinPress) {
            ...
            (0,_utils_storage__WEBPACK_IMPORTED_MODULE_3__.removePortfolioCoinStorage)(clickedCoinId);
            setPortfolioData(updatedPortfolioData);
            setShowInputField(false);
        }
        else {
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: menuIsOpen
            ...
            menuIsOpen && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.scrollContainer },
                ...
                calculatePortfolioValue() > 0 ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioValueField },
                    "$",
                    (0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_5__.amountFormatter)(calculatePortfolioValue()))) : loading ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.emptyPortfolioValueField }, "Loading..")) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.emptyPortfolioValueField }, "Click on coin to add amount")),
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.portfolioItemField },
                    ...
                    (portfolioData === null || portfolioData === void 0 ? void 0 : portfolioData.length) > 0 ? (portfolioData.map((coinInfo, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { key: coinInfo.id },
